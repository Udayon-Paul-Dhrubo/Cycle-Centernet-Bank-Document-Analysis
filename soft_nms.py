...
def py_cpu_softnms(dets, sc, Nt=0.3, sigma=0.5, thresh=0.001, method=2):
    """
    py_cpu_softnms
    :param dets: boexs coordinate matrix format [y1, x1, y2, x2]
    :param sc: the score corresponding to each box
    :param Nt: iou overlapping thresholds
    :param sigma: the variance using the gaussian function
    :param thresh: the final score threshold
    :param method: the method to use
    :return: the index of the boxes left behind
    """
