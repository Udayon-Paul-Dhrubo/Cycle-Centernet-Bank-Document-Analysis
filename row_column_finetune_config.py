...
TEST_NAME = "32_quad_long_row_column_finetune"
EVAL_LAG = 150
CHECKPOINT_LAG = 1
EPOCHS = 150
LR = 0.00125
...
data_root = "/media/quadro/NVME/Mehrab/Current_Experiment/Rows-and-Columns-1/"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/media/quadro/NVME/Mehrab/Current_Experiment/Rows-and-Columns-1/train/_annotations.coco.json",
        img_prefix="train/",
        pipeline=[
...
load_from = "/media/quadro/NVME/Mehrab/exps/32_quad_long_retry/epoch_139.pth"
# load_from = None
resume_from = None
